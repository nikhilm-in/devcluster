...
cp /etc/kubernetes/admin.conf /var/www/html/admin.conf
...
echo "[TASK 5] Exporting Kubeconfig file through nginx on master node ip"

sudo apt install nginx -y
cat <<EOF | sudo tee /var/www/html/config.html
<!DOCTYPE html>
<html>
<head>
